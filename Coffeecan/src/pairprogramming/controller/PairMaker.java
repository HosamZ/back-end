...
public class PairMaker {
    ...
    public static List<Pair> make(List<Participant> participants) {
    ...
    private IntFunction<Pair> toPair(Queue<Participant> participants) {
        return n -> Pair.builder()
                .participants(takeTwo(participants))
                .build();
    }

    private List<Participant> takeTwo(Queue<Participant> participants) {
        return Stream.of(participants.poll(), participants.poll())
                .collect(toList());
    }
